...
/**
 * @description HomePage Возвращает главную станицу, включающую слайдер.
 * @returns {JSX.Element}
 */
        ...
        <>
            <section className="bg-gray-900">
                <div className="grid max-w-screen-xl px-4 mx-auto gap-8 py-16 grid-cols-12">
                    ...
                    <div className="mt-0 col-span-5 flex container">
                        <img className="image w-full max-h-96 " src={pizzaData[currentSlide].image} alt={pizzaData[currentSlide].name} />
                        <NavLink className="overlay" to={`/product/${pizzaData[currentSlide].id}`}>
                            {pizzaData[currentSlide].name}
                        </NavLink>
                    </div>
                </div>
            </section>
